...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/images/master/_listings/data-gov/apis.md
...
- name: Data.gov API - Add Post Image
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/images/master/_listings/data-gov/postspostimage-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/images/master/_listings/data-gov/postspostimage-post-openapi.md
- name: Data.gov API - Update Post Image
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/images/master/_listings/data-gov/postspostimage-put-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/images/master/_listings/data-gov/postspostimage-put-openapi.md
- name: Data.gov API - Add Reuses Reuse Image
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/images/master/_listings/data-gov/reusesreuseimage-post-openapi.md
- name: Data.gov API - Add Reuses Reuse Image
  x-api-slug: reusesreuseimage-post
  description: Upload a new reuse image
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/data-gov-logo.png
