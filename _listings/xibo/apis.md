...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/images/master/_listings/xibo/apis.md
...
- name: Xibo API - Parameters for editing existing image on a layout
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/images/master/_listings/xibo/playlistwidgetimageplaylistid-post-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/images/master/_listings/xibo/playlistwidgetimageplaylistid-post-openapi.md
- name: Xibo API - Parameters for editing existing image on a layout
  x-api-slug: playlistwidgetimageplaylistid-post
  description: Parameters for editing existing image on a layout, for adding new images,
    please refer to POST /library documentation
