...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/images/master/_listings/mattermost/apis.md
...
- name: Mattermost API Reference - Get user's profile image
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/images/master/_listings/mattermost/usersuser-idimage-get-openapi.md
- name: Mattermost API Reference - Set user's profile image
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/images/master/_listings/mattermost/usersuser-idimage-post-openapi.md
- name: Mattermost API Reference - Get custom emoji image
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/images/master/_listings/mattermost/emojiemoji-idimage-get-openapi.md
- name: Mattermost API Reference - Get brand image
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/images/master/_listings/mattermost/brandimage-get-openapi.md
- name: Mattermost API Reference - Upload brand image
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/images/master/_listings/mattermost/brandimage-post-openapi.md
- name: Mattermost API Reference - Get user's profile image
  x-api-slug: usersuser-idimage-get
  description: |-
    Get a user's profile image based on user_id string parameter.
