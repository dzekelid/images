...
- name: Getty Images Add an asset to a board
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/images/master/_listings/getty-images/v3-boards-board-id-assets-asset-id-put.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/images/master/_listings/getty-images/v3-boards-board-id-assets-asset-id-put-postman.md
x-common:
